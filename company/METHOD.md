...
| `quick` | Small bug, copy change, config tweak | No Phase 0, and a quick entry needs no brief - the request is the work order. One developer or the CEO itself. Gates still gate. |
