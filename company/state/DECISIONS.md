...
| 12 | 2026-07-22 | Release v0.2.2 to npm (rolls up unpublished 0.2.1 + #77 model-routing arming) | PREPPED by CEO (this release PR; owner tags v0.2.2 at its merge commit). Publish is the owner's button (link-based 2FA, owner-manual per standing rule); notes: PR #77 body + release PR body | npm registry |
