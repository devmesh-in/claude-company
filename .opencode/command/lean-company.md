...
<!-- GENERATED from .claude/skills/lean-company/SKILL.md by `claude-company render`. Do not edit: edit the source and re-render. -->

Use the skill tool to load the `lean-company` skill, then follow it exactly as written.
